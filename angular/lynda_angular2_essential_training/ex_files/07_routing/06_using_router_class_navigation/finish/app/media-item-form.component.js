    ...
    return {
        ...
        execute: function() {
            MediaItemFormComponent = (function () {
                function MediaItemFormComponent(formBuilder, mediaItemService, router, lookupLists) {
                ...
                MediaItemFormComponent = __decorate([
                    ...
                    __param(3, core_1.Inject(providers_1.lookupListToken)), 
                    __metadata('design:paramtypes', [forms_1.FormBuilder, media_item_service_1.MediaItemService, router_1.Router, Object])
